// Full ISO-3166-1 alpha-2 country list for the billing-country picker.
// The 5 markets where we charge in local currency are flagged via `local`
// and pinned at the top of the picker; everything else charges in USD.
...
// Countries with NO postal code system. We hide the postal field entirely
// for these (Stripe accepts a billing address without postal_code there).
// Source: Universal Postal Union + Stripe address requirements.
...
// Big-5 markets — pinned to the top of the dropdown and charged in their
// local currency. Order matters: US first because that's where most
// buyers come from.
const LOCAL_MARKETS: CountryEntry[] = [
...
// Every other ISO-3166-1 alpha-2 country, alphabetical by name.
...
export const COUNTRIES: CountryEntry[] = [...LOCAL_MARKETS, ...OTHER_COUNTRIES];
